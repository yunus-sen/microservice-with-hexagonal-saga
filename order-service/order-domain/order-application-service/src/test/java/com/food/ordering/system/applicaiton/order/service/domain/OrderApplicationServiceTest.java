...
class OrderApplicationServiceTest {
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        Assertions.assertEquals("Total price: 250.00 is not equal to order item total:  200.00", orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        Assertions.assertEquals(orderDomainException.getMessage(), "Order item price 60.00 is not valid for product: " + PRODUCT_ID);
    }
