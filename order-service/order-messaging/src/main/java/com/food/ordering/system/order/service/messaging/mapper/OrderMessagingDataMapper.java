...
import com.food.ordering.system.applicaiton.domain.event.payload.PaymentOrderEventPayload;
import com.food.ordering.system.applicaiton.domain.event.payload.RestaurantOrderEventPayload;
import com.food.ordering.system.applicaiton.domain.valueobject.OrderApprovalStatus;
import com.food.ordering.system.applicaiton.domain.valueobject.PaymentStatus;
...
public class OrderMessagingDataMapper {
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentOrderEventPayload
        ...
        return PaymentResponse.builder()
                ...
                .createAt(Instant.parse(paymentResponseAvroModel.getCreatedAt()))
